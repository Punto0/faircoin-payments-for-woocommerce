...
//===========================================================================
// Deprecated! uses electrum version 1 mpk
function FWWC__MATH_generate_bitcoin_address_from_mpk ($master_public_key, $key_index)
{
...
// Electrum version 2.x mpk (BIP32)
// Require python and pyfaircoin 
function FWWC__MATH_generate_faircoin_address_from_mpk2 ($mpk, $key_index)
{
$path = "/usr/bin/python ".realpath(dirname(__FILE__))."/generate_address.py";
$order = $path." ".$mpk." ".$key_index;
#FWWC__log_event (__FILE__, __LINE__, $order);
$last_line = system($order, $retval);
#$msg = "Retval : ".$retval." - last_line: ".$last_line;
