...
{
//  FWWC__log_event (__FILE__, __LINE__, "Cron-worker started hardcron : ".$hardcron);
  global $wpdb;
  global $woocommerce;
...
/*  $address_meta =  array (
           'orders' => array ( // All orders placed on this address in reverse chronological order
...
//   $assigned_address_expires_in_secs = 300; // Debugging
//   $funds_received_value_expires_in_secs = 100;
